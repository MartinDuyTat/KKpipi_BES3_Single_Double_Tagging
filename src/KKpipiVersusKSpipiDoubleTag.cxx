...
DECLARE_COMPONENT(KKpipiVersusKSpipiDoubleTag)
...
StatusCode KKpipiVersusKSpipiDoubleTag::FillTuple(DTagToolIterator DTTool_Signal_iter, DTagToolIterator DTTool_Tag_iter, DTagTool &DTTool) {
  ...
  m_TagPiPluspx = findKSpipiTagInfo.GethPlusP(0);
  m_TagPiPluspy = findKSpipiTagInfo.GethPlusP(1);
  m_TagPiPluspz = findKSpipiTagInfo.GethPlusP(2);
  m_TagPiPlusenergy = findKSpipiTagInfo.GethPlusP(3);
  m_TagPiMinuspx = findKSpipiTagInfo.GethMinusP(0);
  m_TagPiMinuspy = findKSpipiTagInfo.GethMinusP(1);
  m_TagPiMinuspz = findKSpipiTagInfo.GethMinusP(2);
  m_TagPiMinusenergy = findKSpipiTagInfo.GethMinusP(3);
  ...
  m_TagPiPluspxKalmanFit = findKSpipiTagInfo.GethPlusPKalmanFit(0);
  m_TagPiPluspyKalmanFit = findKSpipiTagInfo.GethPlusPKalmanFit(1);
  m_TagPiPluspzKalmanFit = findKSpipiTagInfo.GethPlusPKalmanFit(2);
  m_TagPiPlusenergyKalmanFit = findKSpipiTagInfo.GethPlusPKalmanFit(3);
  m_TagPiMinuspxKalmanFit = findKSpipiTagInfo.GethMinusPKalmanFit(0);
  m_TagPiMinuspyKalmanFit = findKSpipiTagInfo.GethMinusPKalmanFit(1);
  m_TagPiMinuspzKalmanFit = findKSpipiTagInfo.GethMinusPKalmanFit(2);
  m_TagPiMinusenergyKalmanFit = findKSpipiTagInfo.GethMinusPKalmanFit(3);
