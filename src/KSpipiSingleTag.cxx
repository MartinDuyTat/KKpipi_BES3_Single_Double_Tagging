...
DECLARE_COMPONENT(KSpipiSingleTag)
...
StatusCode KSpipiSingleTag::FillTuple(DTagToolIterator DTTool_iter, DTagTool &DTTool) {
  ...
  m_PiPluspx = findKSpipiTagInfo.GethPlusP(0);
  m_PiPluspy = findKSpipiTagInfo.GethPlusP(1);
  m_PiPluspz = findKSpipiTagInfo.GethPlusP(2);
  m_PiPlusenergy = findKSpipiTagInfo.GethPlusP(3);
  m_PiMinuspx = findKSpipiTagInfo.GethMinusP(0);
  m_PiMinuspy = findKSpipiTagInfo.GethMinusP(1);
  m_PiMinuspz = findKSpipiTagInfo.GethMinusP(2);
  m_PiMinusenergy = findKSpipiTagInfo.GethMinusP(3);
  ...
  m_PiPluspxKalmanFit = findKSpipiTagInfo.GethPlusPKalmanFit(0);
  m_PiPluspyKalmanFit = findKSpipiTagInfo.GethPlusPKalmanFit(1);
  m_PiPluspzKalmanFit = findKSpipiTagInfo.GethPlusPKalmanFit(2);
  m_PiPlusenergyKalmanFit = findKSpipiTagInfo.GethPlusPKalmanFit(3);
  m_PiMinuspxKalmanFit = findKSpipiTagInfo.GethMinusPKalmanFit(0);
  m_PiMinuspyKalmanFit = findKSpipiTagInfo.GethMinusPKalmanFit(1);
  m_PiMinuspzKalmanFit = findKSpipiTagInfo.GethMinusPKalmanFit(2);
  m_PiMinusenergyKalmanFit = findKSpipiTagInfo.GethMinusPKalmanFit(3);
