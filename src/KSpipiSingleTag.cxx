...
StatusCode KSpipiSingleTag::FillTuple(DTagToolIterator DTTool_iter, DTagTool &DTTool) {
  ...
  m_KSPiPluspxFit = findKSpipiTagInfo.GetKSPiPlusPFit(0);
  m_KSPiPluspyFit = findKSpipiTagInfo.GetKSPiPlusPFit(1);
  m_KSPiPluspzFit = findKSpipiTagInfo.GetKSPiPlusPFit(2);
  m_KSPiPlusenergyFit = findKSpipiTagInfo.GetKSPiPlusPFit(3);
  m_KSPiMinuspxFit = findKSpipiTagInfo.GetKSPiMinusPFit(0);
  m_KSPiMinuspyFit = findKSpipiTagInfo.GetKSPiMinusPFit(1);
  m_KSPiMinuspzFit = findKSpipiTagInfo.GetKSPiMinusPFit(2);
  m_KSPiMinusenergyFit = findKSpipiTagInfo.GetKSPiMinusPFit(3);
