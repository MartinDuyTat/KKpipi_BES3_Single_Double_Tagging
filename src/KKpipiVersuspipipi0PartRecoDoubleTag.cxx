...
DECLARE_COMPONENT(KKpipiVersuspipipi0PartRecoDoubleTag)
...
StatusCode KKpipiVersuspipipi0PartRecoDoubleTag::FillTuple(DTagToolIterator DTTool_Tag_iter, DTagTool &DTTool) {
  ...
  m_TagPiPluspx = findKKpipiVersuspipipi0PartRecoTagInfo.GetpipiTagInfo().GethPlusP(0);
  m_TagPiPluspy = findKKpipiVersuspipipi0PartRecoTagInfo.GetpipiTagInfo().GethPlusP(1);
  m_TagPiPluspz = findKKpipiVersuspipipi0PartRecoTagInfo.GetpipiTagInfo().GethPlusP(2);
  m_TagPiPlusenergy = findKKpipiVersuspipipi0PartRecoTagInfo.GetpipiTagInfo().GethPlusP(3);
  m_TagPiMinuspx = findKKpipiVersuspipipi0PartRecoTagInfo.GetpipiTagInfo().GethMinusP(0);
  m_TagPiMinuspy = findKKpipiVersuspipipi0PartRecoTagInfo.GetpipiTagInfo().GethMinusP(1);
  m_TagPiMinuspz = findKKpipiVersuspipipi0PartRecoTagInfo.GetpipiTagInfo().GethMinusP(2);
  m_TagPiMinusenergy = findKKpipiVersuspipipi0PartRecoTagInfo.GetpipiTagInfo().GethMinusP(3);
