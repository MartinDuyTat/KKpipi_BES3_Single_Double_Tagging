...
DECLARE_COMPONENT(KKpipiVersusKpiDoubleTag)
...
StatusCode KKpipiVersusKpiDoubleTag::execute() {
  ...
  if(DTTool.findDTag(EvtRecDTag::kD0toKKPiPi, EvtRecDTag::kD0toKPi)) {
    ...
    if(FillTupleStatus != StatusCode::SUCCESS) {
      log << MSG::FATAL << "Assigning Kpi tuple info failed" << endreq;
      return StatusCode::FAILURE;
    }
    m_tuple->write();
  }
