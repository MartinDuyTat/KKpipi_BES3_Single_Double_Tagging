...
/**
 * KKpipiVersusKSetaPrimerhogammaDoubleTag is a class for a BOSS algorithm
 * It runs over \f$D^0\bar{D^0}\f$ data and saves all events with a double \f$D\to K^+K^-\pi^+\pi^-\f$ vs \f$D^0\to K_S^0\rho(\pi^+\pi^-)\gamma\f$ tag
...
#ifndef KKPIPIVERSUSKSETAPRIMERHOGAMMADOUBLETAG
#define KKPIPIVERSUSKSETAPRIMERHOGAMMADOUBLETAG
...
class KKpipiVersusKSetaPrimerhogammaDoubleTag: public Algorithm {
  public: 
    /**
     * Default constructor for an algorithm where all necessary properties are declared
     */
    KKpipiVersusKSetaPrimerhogammaDoubleTag(const std::string& name, ISvcLocator* pSvcLocator);
    /**
     * Trivial destructor
     */
    ~KKpipiVersusKSetaPrimerhogammaDoubleTag();
    /**
  ...
  private:
    ...
    /**
     * Tag photon momentum along \f$x\f$
     */
    NTuple::Item<double> m_TagGammapx;
    /**
     * Tag photon momentum along \f$y\f$
     */
    NTuple::Item<double> m_TagGammapy;
    /**
     * Tag photon momentum along \f$z\f$
     */
    NTuple::Item<double> m_TagGammapz;
    /**
     * Tag photon energy
     */
